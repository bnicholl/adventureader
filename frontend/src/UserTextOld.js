...
function TextComp(){
  ...
  const handleSubmit = async (event) => {
    ...
    if (auth.isAuthenticated){
      ...
      //  'Content-Type': 'application/json',
      //},
      //body: JSON.stringify({ inputVal,  pagesToGenerate, createGrammaticalError, username}),
      //});
      //const data = await response.json(); //this data object is the chatGPT generated story
      //navigate('/new-page', { state:  {inputVal, story_text: data['pages_for_story'], image_links : data['image_links_'], gramatical_error_story_text: data['grammar_errord_pages_for_story'], "credits_to_subtract" : pagesToGenerate}  });



      toast.dismiss()
      navigate('/new-page', { state:  {inputVal, pagesToGenerate, createGrammaticalError, username}  });
  ...
  return(
    ...
    <div className="contact-button-container">
      <a
        href="mailto:bnicholl@adventureader.com?subject=Contact Us"
